...
13. Подключить роутер, URL должен менять в зависимости от страницы (Dashboard, Tasks), а также должны менять query параметры на странице Tasks (?filter=done&tag=home и так далее)
